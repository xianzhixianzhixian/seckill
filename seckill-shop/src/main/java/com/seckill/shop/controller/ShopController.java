...
import com.seckill.shop.service.impl.ShopServiceImpl;
...
public class ShopController {
    ...
    public String applyShop(SeckillShop shopInfo, Model model){
    ...
    public String searchShop(SeckillShop shopInfo, Model model){
        List<SeckillShop> listShop = shopService.listShopInfoBy(shopInfo);
    ...
    public String updateState(Long id, Integer state){
        SeckillShop shopInfo = new SeckillShop();
        shopInfo.setId(id);
